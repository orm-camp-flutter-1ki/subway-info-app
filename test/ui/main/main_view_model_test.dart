...
void main() {
  ...
  test('ViewModel Test', () async {
    ...
    await viewModel.getSubwayArrivalInfoList('수원');

    expect(viewModel.state.subwayArrivalInfoList.length, 5);
    expect(viewModel.state.subwayArrivalInfoList[0].station, '수원');
    expect(viewModel.state.subwayArrivalInfoList[0].direction, '상행');
    expect(viewModel.state.subwayArrivalInfoList[0].platform, '청량리행 - 화서방면 (급행)');
    expect(viewModel.state.subwayArrivalInfoList[0].arrivalInfo, '수원 도착');
    expect(viewModel.state.subwayArrivalInfoList[0].transferStationCount, '2');
    expect(viewModel.state.subwayArrivalInfoList[0].arrivalTime, '0');
  });
}
