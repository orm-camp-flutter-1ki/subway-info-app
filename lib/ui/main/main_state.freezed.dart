...
/// @nodoc
mixin _$MainState {
  List<SubwayArrivalInfo> get subwayArrivalInfoList =>
...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<SubwayArrivalInfo> subwayArrivalInfoList, bool isLoading});
}
...
class _$MainStateImpl with DiagnosticableTreeMixin implements _MainState {
  const _$MainStateImpl(
      {final List<SubwayArrivalInfo> subwayArrivalInfoList = const [],
  ...
  final List<SubwayArrivalInfo> _subwayArrivalInfoList;
  @override
  @JsonKey()
  List<SubwayArrivalInfo> get subwayArrivalInfoList {
